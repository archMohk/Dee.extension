...
dee_telemetry.check_access("DeeWBatchUpgrade")


deew_coming_soon.show_coming_soon(
    "DeeW.Batch Upgrade",
    "Will batch-upgrade a folder of local or cloud models to a target Revit version.")
