...
#
# The actual create/bind logic lives in dee_shared_param_service now
# (moved out once DeeSheetLinks needed the SAME parameter names bound to
# Views as well - see that module's own docstring) - this is a thin
# wrapper kept for backward compatibility with this module's own public
# API and test suite, bound to OST_RvtLinks specifically.
# ==========================================================================
def ensure_link_parameters(doc, app, param_names):
    ...
    return dee_shared_param_service.ensure_shared_parameters(
        doc, app, param_names, BuiltInCategory.OST_RvtLinks, "Revit Links",
        transaction_name="DeeLinkDist - Create Link Parameters")
